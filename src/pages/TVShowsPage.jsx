// TVShowsPage.jsx - With Full Functionality Like MoviesPage
...
const STORAGE_KEY = 'tvShowsPageState';
const SCROLL_ITEM_KEY = 'tvShowsScrollItemId';
...
const TVShowsPage = () => {
  ...
  useEffect(() => {
    return () => {
      ...
      if (!currentPath.includes('/tv-shows') && !currentPath.includes('/detail/tv')) {
        sessionStorage.removeItem(STORAGE_KEY);
        sessionStorage.removeItem(SCROLL_ITEM_KEY);
      }
    };
